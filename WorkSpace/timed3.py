    ...
    if initBB is not None:
        ...
        for k in cnts3:
            ...
            if len(approx3) >= 4 and len(approx3) <= 10:
                ...
                if  (success and keepDims3 and keepSolidity3 and keepAspectRatio3) is not True :
                    count2 = count2 + 1
                    print("haci tracking frami içinde kareyi bulamadi ",len(cnts3) )


        #if success:
        if success and count2 < 200: # frame sayısı değil dikkat et cnts kadar artabilir
